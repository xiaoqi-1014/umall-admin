<template>
  <div>
    <el-dialog :title="inof.inofAdd==true? '添加轮播图':'编辑轮播图'" :visible.sync="inof.isshow" @closed="close" @opened='open'>
...
import {reqBannerAdd,reqBannerinfo,reqBanneredit,reqGoodsDetail} from "../../../utils/axios";
export default {
  props: ["inof"],
  components: {},
  data() {
